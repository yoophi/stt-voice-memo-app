...
4. Report only file path and stable forbidden-name/canary category.
5. Never scan or print arbitrary developer environment values.
6. Delete temporary canary fixtures after tests and ignore local environment files.
